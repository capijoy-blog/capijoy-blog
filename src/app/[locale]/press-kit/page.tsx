  ...
  return (
    <div className="mx-auto w-full max-w-5xl space-y-8 px-4 py-12">
      <header className="space-y-2">
        <p className="text-xs uppercase tracking-[0.2em] text-[var(--accent-soft)]">Press Kit</p>
      ...
      <section className="section-card space-y-3 rounded-3xl p-6">
        ...
        <div className="grid gap-2 sm:grid-cols-2">
          <Link
            ...
            className="rounded-2xl bg-black/15 px-4 py-3 text-sm font-semibold text-muted hover:text-[var(--accent-soft)]"
          >
            Spotify
          </Link>
          <Link
